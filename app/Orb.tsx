...
export default function Orb({
  ...
  const frag = /* glsl */ `
    ...
    const vec3 baseColor1 = vec3(0.0, 0.8, 0.4);  // Verde brillante
    const vec3 baseColor2 = vec3(0.2, 0.9, 0.3);  // Verde claro
    const vec3 baseColor3 = vec3(0.0, 0.5, 0.2);  // Verde oscuro
  ...
  useEffect(() => {
    ...
    // Agregar los event listeners al div principal
    const parentDiv = container.parentElement;
    if (parentDiv) {
      parentDiv.addEventListener("mousemove", handleHover);
    ...
    return () => {
      ...
      if (parentDiv) {
        parentDiv.removeEventListener("mousemove", handleHover);
    ...
    <div className="relative w-full h-full">
      ...
      >
        ...
        <div className="relative z-10 pointer-events-none">
          <Image src="/svg/whatsapp.svg" alt="WhatsApp" width={55} height={55} />
        </div>
      </Link>
    </div>
  );
